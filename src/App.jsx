    ...
    <div style={{width:'600px'}} className='bg-light p-5 rounded '>
      ...
      rounded flex-column'>
        ...
        value={year || ""} onChange={(e)=>validateUserInput(e)}/>
          ...
          <Button style={{height:'70px',width:'50%'}} className='bg-dark' variant="contained" type='submit'>Calculate</Button>
          <Button style={{height:'70px',width:'50%'}} className='text-dark' variant="outlined" onClick={Reset}>Reset</Button>
          </Stack>
        </form>
